...
public class CustomerEntry extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == enter) {
            ...
            if( name.isEmpty()){
                JOptionPane.showMessageDialog(null, "Please Enter your name", "Invalid TextFields", JOptionPane.ERROR_MESSAGE);
                return;//return from the method to allow the user to edit the JTextField
            }
            else if( plate.isEmpty()){
                JOptionPane.showMessageDialog(null, "Please Enter your plate number", "Invalid TextFields", JOptionPane.ERROR_MESSAGE);
                return;//return from the method to allow the user to edit the JTextField
            }
            else if( color.isEmpty()){
                JOptionPane.showMessageDialog(null, "Please Enter your car color", "Invalid TextFields", JOptionPane.ERROR_MESSAGE);
                return;//return from the method to allow the user to edit the JTextField
            }
            
            File busySpots = new File("D:\\BusySpots");
...
//                output.println(c.Spot);
            ...
            JOptionPane.showMessageDialog(null, "Ticket Id: " + s + "\nSpot: " + last + "\nPlate Number: " + plate + "\nTime: " + currenttime, "Entered Successfully", JOptionPane.INFORMATION_MESSAGE); 
            this.dispose();
        }
