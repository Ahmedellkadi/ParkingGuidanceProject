...
public class FreeSpots extends JFrame implements ActionListener{
    ...
    public FreeSpots() {
        ...
        back.setBackground(new Color(48, 0, 175));
...
//        }
        ...
        try {
            File file = new File("D:\\BusySpots");
        ...
        /* Frame */
        this.setTitle("Free Spots Monitor");
